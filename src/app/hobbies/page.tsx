...
function HobbiesContent() {
  ...
  useEffect(() => {
    ...
    console.log('🟢 Hobbies page useEffect running (ONCE)');
  ...
  return (
    <>
      <div ref={headerRef} className={`fixed top-0 left-0 right-0 z-50 bg-white/5 backdrop-blur-sm ${isFirstLoad ? 'opacity-0' : ''}`}>
        <Header
      ...
      <div className="min-h-screen relative">
        <div className="max-w-7xl mx-auto px-8 lg:px-16">
          ...
          <div className="lg:col-span-3">
            <CardGrid cards={hobbiesData} gridCols={3} />
          </div>
        </div>
        </div>
      </div>
