      ...
      <div className="min-h-screen relative">
        ...
        {(
          ...
          <div className="lg:sticky top-0 lg:h-screen flex justify-center relative pt-16 lg:pt-24">
            <div
              ref={leftContentRef}
              className="flex flex-col justify-start px-8 lg:px-12 pt-6 lg:py-12 space-y-8 lg:space-y-12 relative z-10 backdrop-blur-xl rounded-2xl border border-white/0 h-auto lg:h-[680px] transition-opacity duration-300"
              style={{
